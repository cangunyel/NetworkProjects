...
class FourSectionsGUI:
    def __init__(self, master):
        ...
        self.tk_image1 = None
        self.tk_image2 = None
        self.image_path1 = "rdt1/rdt1reciever.png"
        self.image_path2 = "rdt1/rdt1sender.png"
    ...
    def show_images(self):
        ...
        canvas.create_image(550, 150, anchor=tk.CENTER, image=self.tk_image1)
        canvas.create_image(150, 150, anchor=tk.CENTER, image=self.tk_image2)
    ...
    def update_results(self):
        ...
        if re.match(r"rdt_send()", figure):
            ...
            self.text_part1.insert(tk.END, "rdt_rcv(packet)\n\n"+"\nextract (packet,data)\ndeliver_data(data)")
